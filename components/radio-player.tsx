    ...
    >
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center p-4 px-2 sm:px-4">
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <Button
                onClick={togglePlay}
                size="lg"
                className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 border-0 flex-shrink-0 shadow-lg transition-all duration-200 hover:scale-110 active:scale-95"
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                <Button
                  ...
                  size="sm"
                  onClick={toggleMute}
                  className="text-white hover:bg-gray-700 flex-shrink-0 p-1 sm:p-2 transition-all duration-200 hover:scale-110 active:scale-95"
                >
                  {isMuted || volume[0] === 0 ? (
        ...
        <div className="flex flex-row gap-2 sm:gap-3 mb-6 sm:mb-8 w-full max-w-sm sm:max-w-md justify-center items-center">
          <Button
            className="bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-white px-3 sm:px-6 py-2 rounded-full text-xs sm:text-base shadow-lg flex-1 sm:flex-none transition-all duration-200 hover:scale-105 active:scale-95"
          ...
          <Button
            className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white px-3 sm:px-6 py-2 rounded-full text-xs sm:text-base shadow-lg flex-1 sm:flex-none transition-all duration-200 hover:scale-105 active:scale-95"
            onClick={() => window.open("https://discord.com/invite/aCeNspzQzn", "_blank")}
          >
          ...
          <Button
            className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white px-3 sm:px-6 py-2 rounded-full text-xs sm:text-base shadow-lg flex-1 sm:flex-none transition-all duration-200 hover:scale-105 active:scale-95"
        ...
        <div className="mb-6 sm:mb-8">
          <Button
            className="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base shadow-lg transition-all duration-200 hover:scale-105 active:scale-95"
            onClick={() => window.open("https://forms.gle/bUXDWVJv66aGHGAD9", "_blank")}
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <path
                d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-4-4-4zm0 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"
                opacity="0.7"
              />
            </svg>
            Quero ser da Equipe
